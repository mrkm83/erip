...
const Onlinesfailed = ({ navigation }) => {
    ...
    return (
        <ScrollView style={{ backgroundColor: "white" }} >
            ...
            <View style={{ flex: 1, flexDirection: 'column' }}>
                ...
                <View style={{ height: moderateScale(150), width: '80%', marginLeft: moderateScale(33), alignItems: 'center', justifyContent: 'center' }}>
                    <Image
                        source={imagePath.failed}
                        style={{ height: moderateScale(150), width: "100%", resizeMode: "contain" }}
                    />
                </View>
                ...
                <View style={{
                    ...
                    >
                        ...
                        <Text style={{ textAlign: "center", fontSize: scale(16), marginLeft: moderateScale(15), color: "#0085FF" }}>
