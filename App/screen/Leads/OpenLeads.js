    ...
    const renderItem = ({ item }) => {
        ...
        return <View style={{
            ...
            borderRadius: moderateScale(10), marginLeft: moderateScale(10), paddingHorizontal: moderateScale(10)
             ...
             <TouchableOpacity onPress={()=>lead_details(item.order_id_encrypted,item.order_job_started)}>
            ...
            <View style={{ flexDirection: 'row', height: moderateVerticalScale(100), justifyContent: 'space-between' }}>
