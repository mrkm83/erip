...
const Orederdetailes3 = ({ navigation }) => {
                ...
                >
                    <View style={{
                        ...
                        <View style={{
                            ...
                            width: "35%", borderBottomStartRadius: 40, justifyContent: "center", alignItems: "center"
                        }}>
                            <Text style={{ textAlign: "center", fontSize: scale(15), color: 'black', fontWeight: "700" }}>
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{
                                            height: moderateScale(45), justifyContent: "center"
                                            , width: "56%",
                                        }}>
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{
                                            height: moderateScale(75), justifyContent: "center", alignItems: "center"
                                            , width: '19%',
                                        }}>
...
export default Orederdetailes3